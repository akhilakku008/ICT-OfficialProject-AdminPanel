...
function sidebarType(e) {
    ...
    "bg-transparent" != a && "bg-white" != a || !i ? (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct-dark.png") && (d = o.replace("logo-ct-dark", "logo-ct"), r.src = d) : (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (d = o.replace("logo-ct", "logo-ct-dark"), r.src = d), "bg-white" == a && n && (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (d = o.replace("logo-ct", "logo-ct-dark"), r.src = d)
}
